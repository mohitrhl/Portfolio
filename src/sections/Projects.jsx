...
// Framer Motion element shorthand
const MH3 = motion.h3;

// ---------- HOOK: Detect Mobile Device ----------
// This hook checks if screen width is <= 639px (mobile).
// It helps in switching between mobile and desktop preview images.
function useIsMobile(query = "(max-width: 639px)") {
  ...
  React.useEffect(() => {
    ...
    // Modern + legacy browser compatibility
...
export default function Projects() {
  ...
  // ---------- PROJECT DATA ----------
  // Change this array to add YOUR projects:
  // Each project contains:
  // - title: name of the project
  // - link: live project link
  // - bgColor: background color shown during scroll
  ...
  return (
    ...
    >
      {/* Sticky container: projects stay in center while background changes */}
            ...
            >
              ...
              >
                <img
                  ...
                  loading="lazy" // lazy load improves performance
                />
